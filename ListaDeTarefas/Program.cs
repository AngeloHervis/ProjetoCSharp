...
app.MapPost("/ListaDeTarefas/cadastrar/tarefa", ([FromBody] Tarefa tarefa, [FromServices] AppDbContext context) =>
{
    Tarefa? tarefaBuscada = context.Tarefas.FirstOrDefault(n => n.Nome.ToUpper() == tarefa.Nome.ToUpper());
...
app.MapGet("/ListaDeTarefas/buscar/tarefa/{id}", ([FromRoute] string id,
    [FromServices] AppDbContext context) =>
{
    ...
    return Results.Ok(new { Id = tarefa.Id, Nome = tarefa.Nome, Descricao = tarefa.DescricaoTarefa });
});

// ENDPOINT PARA LISTAR Tarefa
app.MapGet("/ListaDeTarefas/listar/tarefa", ([FromServices] AppDbContext context) =>
{
    if (context.Tarefas.Any())
    {
        // Retorna uma lista de tarefas com Descricao
        return Results.Ok(context.Tarefas.Select(t => new { Id = t.Id, Nome = t.Nome, Descricao = t.DescricaoTarefa }).ToList());
    }
...
app.MapPut("/ListaDeTarefas/atualizar/tarefa/{id}", ([FromRoute] string id, [FromBody] Tarefa tarefaAtualizada
    , [FromServices] AppDbContext context) =>
{
    ...
    Tarefa? tarefaDuplicada = context.Tarefas.FirstOrDefault(n => n.Nome.ToUpper() == tarefaAtualizada
        .Nome.ToUpper() && n.Id != id);
...
app.MapDelete("/ListaDeTarefas/deletar/tarefa/{id}", ([FromRoute] string id, [FromServices] AppDbContext context) =>
{
...
app.MapPost("ListaDeTarefas/cadastrar/usuario", ([FromBody]Usuario usuario, [FromServices] AppDbContext context) =>{
...
app.MapGet("/ListaDeTarefas/buscar/usuario/{id}", ([FromRoute] string id,
    [FromServices] AppDbContext context) =>
{
...
app.MapGet("ListaDeTarefas/listar/usuario", ([FromServices] AppDbContext context) =>
{
...
app.MapDelete("/ListaDeTarefas/deletar/usuario/{id}", ([FromRoute] string id, [FromServices] AppDbContext context) =>
{
...
app.MapPut("/ListaDeTarefas/alterar/usuario/{id}", ([FromRoute] string id, [FromBody] Usuario usuarioAlterado, [FromServices] AppDbContext context) =>
{ 
